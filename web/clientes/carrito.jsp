...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/codebase/calendar.min.css" rel="stylesheet" media="all" type="text/css">
        
        <script src="https://unpkg.com/axios@0.21.1/dist/axios.min.js"></script>
        <script type="text/javascript" src="../codebase/calendar.min.js"></script>
        <script type="text/javascript" src="../scripts/Ejer3.9.js"></script>
        <script src="../scripts/P9_Ejer3.3_TRABAJO.js" type="text/javascript"></script>
                            ...
                            <table width="95%" cellspacing="0">
                                ...
                                <c:forEach var="pedidolinea" items="${pedido.getLineas()}">
                                    <tr >
                                        ...
                                        <td>
                                            <input class="cantidad" min="1"  type="number" name="C_${pedidolinea.getCodigo()}" size="3" value="${pedidolinea.getCantidad()}">
                                        </td>
                                        <td>
                                            <input class ="fecha" type="text" name="F_${pedidolinea.getCodigo()}" size="10" value="<fmt:formatDate value="${pedidolinea.getFechaEntregaDeseada().getTime()}" pattern="dd/MM/yyyy"/>">			  
                                        </td>
                                    </tr>
                                </c:forEach>
